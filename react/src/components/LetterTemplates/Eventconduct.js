                ...
                <div className="booking-form">
                    <form id="txtb" method="POST" action="/conductevent">
                        ...
                        <div className="form-group">
                            ...
                            <input required className="form-control" type="text" for="event_name" placeholder="Enter name" onChange={e => setEventname(e.target.value)}/>
                        </div>
                        <br />
                        <div className="form-group">
                            <span className="form-label" for="hall_name">Enter Hall Name : </span>
                            <input required className="form-control" type="text" name="hall_name" placeholder="Enter name" onChange={e => setHallname(e.target.value)}/>
                        </div>
                        <br />
                        ...
                        <div className="form-group">
                            ...
                            <input required className="form-control" type="text" name="letter_body" placeholder="Enter about Event" onChange={e => setLetterbody(e.target.value)}/>
                        </div>
                        <br />
