                            ...
                            <div className="booking-form">
                                <form id="txtb" method="POST" action="/TeamAttendance">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="text" name="subject" onChange={e => setSubject(e.target.value)} placeholder="Enter subject (ex: Requisition of attendance for Organising Committee)" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="text" name="team_name" onChange={e => setTeamname(e.target.value)} placeholder="Enter name" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="event_name">Event name : </span>
                                        <input className="form-control" type="text" name="event_name" onChange={e => setEventname(e.target.value)} placeholder="Enter event name" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="letter_body">Letter Body : </span>
                                        <input className="form-control" type="text" name="letter_body" onChange={e => setLetterbody(e.target.value)} placeholder="Describe your Event" />
                                    </div>
                                    <br />
