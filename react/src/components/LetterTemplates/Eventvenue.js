                ...
                <div className="booking-form">
                    <form id="txtb" method="POST" action="/usehall">
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" name="team_name" type="text" placeholder="Enter name" onChange={e => setTeamname(e.target.value)}/>
                        </div>
                        <br />
                        <div className="form-group">
                            <span className="form-label" for="event_name">Your Event Name : </span>
                            <input className="form-control" type="text" name="event_name" placeholder="Enter name" onChange={e => setEventname(e.target.value)}/>
                        </div>
                        <br />
                        <div className="form-group">
                            <span className="form-label" for="reason">Reason : </span>
                            <input className="form-control" name="reason" type="text" placeholder="i.e Conduct/Work for" onChange={e => setReason(e.target.value)}/>
                        </div>
                        <br />
                        <div className="form-group">
                            <span className="form-label" for="hall_name">Enter Hall Name : </span>
                            <input className="form-control" type="text" name="hall_name" placeholder="Enter Hall name" onChange={e => setHallname(e.target.value)}/>
                        </div>
                        <br />
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" name="letter_body" type="text" placeholder="Enter about Event" onChange={e => setLetterbody(e.target.value)}/>
                        </div>
                        <br />
