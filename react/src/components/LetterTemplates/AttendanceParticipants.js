                        ...
                        <div className="row">
                            <div className="booking-form">
                                ...
                                <div className="form-group">
                                    ...
                                    <input className="form-control" type="text" placeholder="Enter subject (ex: Requisition of attendance for Participants)" />
                                </div>
                                <br />
                                <div className="form-group">
                                ...
                                <br />
                                <div className="form-group">
                                    <span className="form-label">Forum/Team name : </span>
                                    <input className="form-control" type="text" placeholder="Enter name" />
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label">Event name : </span>
                                    <input className="form-control" type="text" placeholder="Enter event name" />
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label">Letter Body : </span>
                                    <input className="form-control" type="text" placeholder="Describe your Event" />
                                </div>
                                <br />
