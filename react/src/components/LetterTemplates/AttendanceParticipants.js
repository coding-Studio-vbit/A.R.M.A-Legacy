        ...
        <form onSubmit={handleSubmit}>
            <div id="booking" className="section">
                        ...
                        <div className="row">
                            <div className="booking-form">
                                <form id="txtb" method="POST" action="/participantsattendance">
                                    ...
                                    <span className="form-label" htmlFor="designation">Designation: </span>
                                    <select required className="form-control" name="designation" onChange={e =>{e.persist(); setDesignation(e.target.value)}}>
                                ...
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="department">Department: </span>
                                ...
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="date">Current Date: </span>
                                    <input className="form-control" type="date" name="date" required onChange={e => setDate(e.target.value)}/>
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="subject">Subject: </span>
                                    <input required className="form-control" type="text" name="subject" onChange={e => setSubject(e.target.value)} placeholder="Enter subject (ex: Requisition of attendance for Participants)" />
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="respects">Respects: </span>
                                ...
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="team_name">Forum/Team name : </span>
                                    <input required className="form-control" type="text" name="team_name" placeholder="Enter name" onChange={e => setTeamname(e.target.value)}/>
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="event_name">Event name : </span>
                                    <input required className="form-control" type="text" name="event_name" placeholder="Enter event name" onChange={e => setEventname(e.target.value)}/>
                                </div>
                                <br />
                                <div className="form-group">
                                    <span className="form-label" htmlFor="letter_body">Letter Body : </span>
                                    <input required className="form-control" type="text" name="letter_body" placeholder="Describe your Event" onChange={e => setLetterbody(e.target.value)}/>
                                </div>
                                <br />
                                ...
                                <div className="row">
                                    <div className="col-sm-5">
                                        <div className="form-group">
                                        <span className="form-label" htmlFor="fromdate">From</span>
                                ...
                                <div className="col-sm-7">
                                    <div className="row">
                                        <div className="col-sm-4">
                                            <div className="form-group">
                                            <span className="form-label" htmlFor="start_hour">Hour</span>
                                ...
                                <div className="col-sm-4">
                                    <div className="form-group">
                                        <span className="form-label" htmlFor="start_min">Min</span>
                                ...
                                <div className="col-sm-4">
                                    <div className="form-group">
                                        <span className="form-label" htmlFor="start_meridian">AM/PM</span>
                ...
                <div className="row">
                    <div className="col-sm-5">
                        <div className="form-group">
                            <span className="form-label" htmlFor="todate">To</span>
                    ...
                    <div className="col-sm-7">
                        <div className="row">
                            <div className="col-sm-4">
                                <div className="form-group">
                                    <span className="form-label" htmlFor="end_hour">Hour</span>
                            ...
                            <div className="col-sm-4">
                                <div className="form-group">
                                    <span className="form-label" htmlFor="end_min">Min</span>
                            ...
                            <div className="col-sm-4">
                                <div className="form-group">
                                    <span className="form-label" htmlFor="end_meridian">AM/PM</span>
