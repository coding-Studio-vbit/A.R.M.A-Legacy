    ...
    const [inputFields, setInputFields] = useState([
      ...
      const handleSubmit = e => {
        ...
        console.log(team_name, designation, department, date, subject, respects, event_name, letter_body, fromdate, start_hour, start_min,
                    start_meridian, todate, end_hour, end_min, end_meridian, where);
      ...
      const submit = (e) => {
            ...
            axios.post('/campaigning', { designation, department, date, subject, respects, team_name, event_name, fromdate, todate, start_hour, start_min, start_meridian,
             end_hour, end_min, end_meridian, letter_body, studentdetails, where},{responseType: 'arraybuffer'})
           .then((result) => {
            console.log(result)
            ...
            <div id="booking" className="section">
                <div className="section-center">
                            ...
                            <div className="booking-form">
                                <form id="txtb" method="POST" action="/campaigning">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input required className="form-control" name="subject" placeholder="Enter Letter Subject" onChange={e => setSubject(e.target.value)}/>
                                    </div>
                                    <br />
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input required className="form-control" name="event_name" placeholder="Enter event name" onChange={e => setEventname(e.target.value)}/>
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="where">Inside / Outside : </span>
                                            <select required className="form-control" name="where" onChange={e => setWhere(e.target.value)}>
                                                <option value="" disabled selected hidden>Select your option</option>
                    ...
                    <div className="form-group">
                        ...
                        <input required className="form-control" type="text" name="letter_body" onChange={e => setLetterbody(e.target.value)} placeholder="Enter about Event" />
                    </div>
					<br />
