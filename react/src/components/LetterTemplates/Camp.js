            ...
            <div id="booking" className="section">
                <div className="section-center">
                            ...
                            <div className="booking-form">
                                <form id="txtb" method="POST" action="/campaigning">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" name="subject" placeholder="Enter Letter Subject" onChange={e => setSubject(e.target.value)}/>
                                    </div>
                                    <br />
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" name="event_name" placeholder="Enter event name" onChange={e => setEventname(e.target.value)}/>
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="where">Inside / Outside : </span>
                                            <select className="form-control" name="where" onChange={e => setWhere(e.target.value)}>
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control" type="text" name="letter_body" onChange={e => setLetterbody(e.target.value)} placeholder="Enter about Event" />
                    </div>
					<br />
