...
const Emeet = () => {
    const [inputFields, setInputFields] = useState([
      ...
      const handleSubmit = e => {
        e.preventDefault();
        console.log(team_name, designation, department, date, subject, respects, event_name,hall_name, letter_body, fromdate, start_hour, start_min,
                    start_meridian, end_hour, end_min, end_meridian);
      ...
      const submit = (e) => {
            ...
            axios.post('/conductmeet', { designation, department, date, subject, respects, team_name, event_name,hall_name, fromdate, start_hour, start_min, start_meridian,
                        ...
                        <div className="row">
                            <div className="booking-form">
                                <form id="txtb" method="POST" action="/conductmeet">
                                    <h3 style={{textAlign: 'center'}}>Permission to conduct a meet</h3>
                                    <br/><br/>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="date" name="date" onChange={e => setDate(e.target.value)} required />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="subject">Subject: </span>
                                        <input required className="form-control" type="text" name="subject" onChange={e => setSubject(e.target.value)} placeholder="Enter subject (ex: Requisition of attendance for Organising Committee)" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input required className="form-control" type="text" name="team_name" onChange={e => setTeamname(e.target.value)} placeholder="Enter name" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                        <span className="form-label" for="event_name">Event name : </span>
                                        <input required className="form-control" type="text" name="event_name" onChange={e => setEventname(e.target.value)} placeholder="Enter event name" />
                                    </div>
                                    <br />
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input required className="form-control" type="text" name="letter_body" onChange={e => setLetterbody(e.target.value)} placeholder="Describe your Event" />
                                    </div>
                                    <br />
                                    ...
                                    <div className="row">
                                        <div className="col-sm-5">
                                            ...
                                            <input className="form-control" name="fromdate" onChange={e => setFromdate(e.target.value)} type="date" required />
                                        </div>
                                    </div>
