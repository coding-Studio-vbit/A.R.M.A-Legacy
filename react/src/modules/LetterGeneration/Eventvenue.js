...
const Evenue = () => {
  ...
  const isSubmit = date ==="" || subject === ""|| reason===""||hall_name===""|| respects ===""||team_name===""||event_name===""||letter_body===""||fromdate===""||start_hour===""||start_min===""||start_meridian===""||todate===""||end_hour===""||end_min===""||end_meridian===""? false:true
              ...
              <div className="booking-form">
                <form id="txtb" method="POST" action="/eventvenue">
                  <h3 style={{ textAlign: "center" }}>
                    Permisssion to use hall for conducting event / use hall to
                    work
                  </h3>
                  <br />
                  <br />
                  ...
                  <br />
                  <div className="form-group">
                    <span className="form-label" for="reason">
                      Reason :{" "}
                    </span>
                    <input
                      required
                      ...
                      name="reason"
                      type="text"
                      placeholder="i.e Conduct/Work for"
