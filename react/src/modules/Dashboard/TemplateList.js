...
class TemplateList extends React.Component {
  ...
  componentWillMount() {
    ...
    axios
      .get(`${process.env.REACT_APP_URL}/getPersonalTemplateList`, config)
      .then((res) => {
        const personalTemplates = res.data.personalTemplateList;
        var newTemplates = [];
        personalTemplates.forEach((item, i) => {
          newTemplates.push({
            subject: item,
            type: "personal",
            linkName: "/dynamic",
        ...
        newTemplates = newTemplates.concat(this.state.template);
        this.setState({ template: newTemplates });
      })
      .catch((err) => {
        console.log(err);
      });
