...
{
    var content = fs.readFileSync(path.resolve(__dirname, './LetterTemplate/PERMIT_EVENT_IN_HALL_TEMPLATE.docx'), 'binary');
    ...
    try{
            ...
            var filename = 'FINAL_HALL_UTILIZATION_PERMISSION';
